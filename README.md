...
**RuneTouch** — это аркадная игра на iOS, в которой ты отражаешь нападающих врагов с помощью магических жестов. Рисуй руны, чтобы активировать заклинания и защищать башню. Вдохновлено *Magic Touch* от Nitrome.
...
- [x] Игровая сцена с падающими врагами
- [x] Обработка жестов и рун
- [x] Уничтожение врагов при совпадении
- [ ] Game Over экран
- [ ] HUD: очки, жизни
- [ ] Настройки (звук, тема)
...
```bash
git clone https://github.com/yourusername/RuneTouch.git
cd RuneTouch
...
Создано с магией и Swift — [@yourhandle](https://github.com/yourhandle)
